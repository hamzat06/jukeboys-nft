      ...
      <div className="container mx-auto max-w-6xl flex items-center justify-between flex-wrap px-5">
        ...
        <div className={
          ...
          <div className="lg:space-x-10 items-center">
            ...
            <a href="https://discord.gg/rgZJ85dy" target="_blank" rel="noreferrer" className="block mt-4 lg:inline-block lg:mt-0 text-xl lg:hover:rotate-12 lg:hover:transition lg:hover:delay-150 lg:hover:duration-300 lg:hover:ease-in-out lg:hover:scale-110 lg:relative lg:top-1">
