        ...
        <div className="container mx-auto max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:translate-y-32 justify-center pb-24 md:pb-0">
          {
            featuresArray.map((feature) => {
              return (
                <div className="bg-white p-6 md:p-8 lg:p-14 rounded-3xl shadow-md text-center lg:hover:transition lg:hover:delay-150 lg:hover:duration-300 lg:hover:ease-in-out lg:hover:scale-110">
