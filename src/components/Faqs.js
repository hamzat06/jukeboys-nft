    ...
    <div className="py-36" id="faqs">
      <div className="container mx-auto max-w-5xl space-y-8 px-10">
...

        {
          faqs.map((faq) => {
            return (
              <div className={`block sm:flex gap-6 px-8 md:pr-32 py-8 ${faq.bgColor} lg:hover:transition lg:hover:delay-150 lg:hover:duration-300 lg:hover:ease-in-out lg:hover:scale-110`}>
